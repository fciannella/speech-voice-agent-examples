...
async def create_pipeline_task(pipeline_metadata: PipelineMetadata):
    ...
    """
    vad_params = VADParams(stop_secs=0.24)
    ...
    speech_planner = SpeechPlanner(
        ...
        api_key=os.getenv("NVIDIA_API_KEY"),
        model=os.getenv("NVIDIA_SLM_MODEL", "google/gemma-2-2b-instruct"),
        base_url=os.getenv("NVIDIA_SLM_URL", "http://localhost:8080/v1"),
